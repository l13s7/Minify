...
class JavaScriptSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Fahri5567\Minify\Providers\JavaScript');
    }
    ...
    {
        $this->shouldThrow('Fahri5567\Minify\Exceptions\FileNotExistException')
            ->duringAdd('foobar');
    }
    ...
    function it_should_throw_exception_when_buildpath_not_exist()
    {
      ...
      $this->shouldThrow('Fahri5567\Minify\Exceptions\DirNotExistException')
            ->duringMake('dir_bar');
    }
    ...
    function it_should_throw_exception_when_buildpath_not_writable()
    {
        ...
        $this->shouldThrow('Fahri5567\Minify\Exceptions\DirNotWritableException')
